...
class PTB_Admin {
    ...
    ?>  
        <form class="ptb-flush-form" action="" method="post">
            ...
            <?php submit_button(__('Flush Permlinks', 'ptb'));
    ...
    public function enqueue_scripts() {
        ...
        if ($screen->id != 'customize') {
            $screens = array('post-type-builder_page_ptb-ptt', 'toplevel_page_ptb-cpt', 'post-type-builder_page_ptb-ctx', 'post-type-builder_page_ptb-ie');
